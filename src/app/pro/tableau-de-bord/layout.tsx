  ...
  return (
    <div className="grid grid-cols-[200px_1fr] gap-6 px-4 py-8">
      <aside className="space-y-1 text-sm">
        ...
        <Link
          href="/pro/tableau-de-bord/messagerie"
          className="block rounded-lg px-3 py-2 hover:bg-black/5"
        >
          Messagerie
        </Link>
        <Link
          href="/pro/tableau-de-bord/equipe"
          className="block rounded-lg px-3 py-2 hover:bg-black/5"
        >
          Équipe &amp; horaires
        </Link>
        <Link
          href="/pro/tableau-de-bord/reglages"
          className="block rounded-lg px-3 py-2 hover:bg-black/5"
        >
          Réglages
        </Link>
        <Link
          href="/pro/tableau-de-bord/clients"
          className="block rounded-lg px-3 py-2 hover:bg-black/5"
        >
          Clients
        </Link>
        <Link
          href="/pro/tableau-de-bord/caisse"
          className="block rounded-lg px-3 py-2 hover:bg-black/5"
        >
          Caisse
        </Link>
        <Link
          href="/pro/tableau-de-bord/statistiques"
          className="block rounded-lg px-3 py-2 hover:bg-black/5"
        >
          Statistiques
        </Link>
